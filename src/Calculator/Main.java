...
public class Main {
    public static void main(String[] args) {
        ...
        // Реализация TreeSet с сортировкой от минимального до максимального результата
        ALogCalculatorWithSort aLogCalculatorWithSort = new ALogCalculatorWithSortImpl();
        ...
        aLogCalculatorWithSort.calculate("sum");
        aLogCalculatorWithSort.calculate("min");
        aLogCalculatorWithSort.calculate("div");
        aLogCalculatorWithSort.calculate("mul");
        aLogCalculatorWithSort.showCalculatorLogAndSortResult();
